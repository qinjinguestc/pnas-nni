...
path = r'/media/uestcer429/Data/Datasets/Brats/BRATS2015/Testing/HGG_LGG'
...
class BRATS2015:
    ...
    #     img_array = np.expand_dims(img_array, -attention)
    #     # X_train_minmax = img_array.reshape(n, w, h, attention)
    #     return img_array
    ...
    def next_test_MHA(self):
        ...
        # self.arr_test_ot[self.arr_test_ot == 0] = -attention
